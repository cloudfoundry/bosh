...
gcloud sql users delete -q "${GCP_POSTGRES_USERNAME}" --instance "${postgres_instance_name}"
gcloud sql users delete -q "${GCP_MYSQL_USERNAME}" --instance "${mysql_instance_name}"
