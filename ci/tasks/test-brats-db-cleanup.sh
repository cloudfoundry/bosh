...
echo 'Cleanup RDS ============================'
cleanup_mysql "${RDS_MYSQL_EXTERNAL_DB_HOST}" "${RDS_MYSQL_EXTERNAL_DB_USER}" \
              "${RDS_MYSQL_EXTERNAL_DB_PASSWORD}" "${RDS_MYSQL_EXTERNAL_DB_NAME}"
cleanup_postgres "${RDS_POSTGRES_EXTERNAL_DB_HOST}" "${RDS_POSTGRES_EXTERNAL_DB_USER}" \
                  "${RDS_POSTGRES_EXTERNAL_DB_PASSWORD}" "${RDS_POSTGRES_EXTERNAL_DB_NAME}"

echo 'Cleanup GCP ============================'
cleanup_mysql "${GCP_MYSQL_EXTERNAL_DB_HOST}" "${GCP_MYSQL_EXTERNAL_DB_USER}" \
              "${GCP_MYSQL_EXTERNAL_DB_PASSWORD}" "${GCP_MYSQL_EXTERNAL_DB_NAME}"
cleanup_postgres "${GCP_POSTGRES_EXTERNAL_DB_HOST}" "${GCP_POSTGRES_EXTERNAL_DB_USER}" \
                  "${GCP_POSTGRES_EXTERNAL_DB_PASSWORD}" "${GCP_POSTGRES_EXTERNAL_DB_NAME}"
