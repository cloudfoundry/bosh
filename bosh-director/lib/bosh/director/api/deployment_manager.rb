module Bosh::Director
  module Api
    class DeploymentManager
      ...
      def create_deployment(username, deployment_name, deployment_manifest, cloud_config, options = {})
        ...
        JobQueue.new.enqueue(username, Jobs::UpdateDeployment, "create deployment #{deployment_name}", [deployment_manifest_file, cloud_config_id, options])
      end
