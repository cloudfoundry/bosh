  ...
  class JobUpdater
    ...
    def update
      ...
      instance_plans.each do |instance_plan|
        @logger.debug("Need to update instance '#{instance_plan.instance}', changes: #{instance_plan.instance.changes.inspect}")
      end
    ...
    def delete_unneeded_instances
      ...
      deleter = InstanceDeleter.new(@deployment_plan, DeploymentPlan::IpProviderV2.new(DeploymentPlan::IpRepoThatDelegatesToExistingStuff.new))
