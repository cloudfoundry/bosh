        ...
        class Plan
          ...
          def create_instance_plans(desired, existing, networks, availability_zones, job_name)
            ...
            instance_plans.reject(&:obsolete?).each do |instance_plan|
              ...
              instance_plan.instance.assign_availability_zone_and_update_cloud_properties(instance_plan.desired_instance.az, instance_plan.desired_instance.job.vm_type, instance_plan.desired_instance.job.vm_extensions)
            end
            instance_plans
          end
