module Bosh::Director::DeploymentPlan
  class InstanceRepository
    ...
    def fetch_existing(desired_instance, existing_instance_model, existing_instance_state)
      ...
      instance = Instance.new(desired_instance.job, desired_instance.index, job_state, desired_instance.deployment, existing_instance_state, existing_instance_model.availability_zone, @logger)
    ...
    def create(desired_instance, index)
      ...
      instance = Instance.new(desired_instance.job, index, job_state, desired_instance.deployment, nil, desired_instance.az, @logger)
