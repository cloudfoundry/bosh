  ...
  module DeploymentPlan
    ...
    class Instance
      ...
      def self.fetch_existing(desired_instance, existing_instance_model, existing_instance_state, logger)
        ...
        instance = new(desired_instance.job, desired_instance.index, desired_instance.state, desired_instance.deployment, existing_instance_state, desired_instance.az, desired_instance.bootstrap, logger)
