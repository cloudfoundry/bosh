...
module Bosh::Director
  describe Stopper do
    ...
    before { allow(AgentClient).to receive(:with_vm_credentials_and_agent_id).with(instance_model.credentials, instance_model.agent_id, {stop_message_timeout: config.stop_message_timeout}).and_return(agent_client) }
