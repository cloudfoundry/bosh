...
module Bosh::Director::DeploymentPlan
  describe AvailabilityZone do
    subject(:availability_zone) { AvailabilityZone.new(availability_zone_spec) }
    ...
    describe 'name' do
      context 'is not present' do
        ...
        it 'raises error' do
          expect{AvailabilityZone.new(availability_zone_spec)}.to raise_error(BD::ValidationMissingField)
        end
      end
      ...
      context 'is not a string' do
        ...
        it 'raises error' do
          expect{AvailabilityZone.new(availability_zone_spec)}.to raise_error(BD::ValidationInvalidType)
        end
      end
    end
