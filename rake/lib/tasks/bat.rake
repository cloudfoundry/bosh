...
data_dog_formatter_path = File.expand_path('../../dev/data_dog_formatter.rb', __FILE__)
rspec_opts << "--format Bosh::Dev::DataDogFormatter --require #{data_dog_formatter_path}" if ENV.key?('BAT_DATADOG_API_KEY')
