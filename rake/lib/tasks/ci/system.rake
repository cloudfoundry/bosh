    ...
    task :micro, [:infrastructure] do |_, args|
      ...
      cd(ENV['WORKSPACE']) do
        begin
          ...
          pipeline.download_latest_stemcell(infrastructure: infrastructure, name: 'micro-bosh-stemcell')
          pipeline.download_latest_stemcell(infrastructure: infrastructure, name: 'bosh-stemcell')
