namespace :ci do
  ...
  task :publish_stemcell_in_vm, [:infrastructure_name, :operating_system_name, :operating_system_version, :vm_name, :agent_name, :os_image_s3_bucket_name, :os_image_s3_key, :os_image_s3_version] do |_, args|
    require 'bosh/dev/build'
