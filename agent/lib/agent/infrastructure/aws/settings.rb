module Bosh::Agent
  class Infrastructure::Aws::Settings
    ...
    def get_network_settings
      ...
      networks = {"default" => {}}
      networks["default"]["ip"] = ip
      networks["default"]["netmask"] = netmask
      # XXX Should we return security group or some such?
      networks["default"]["cloud_properties"] = {"name" => "dummy"}
      networks["default"]["dns"] = nameservers
      networks["default"]["gateway"] = gateway
      networks
    end
