...
# Start compiler
/var/vcap/bosh/bin/ruby ${bosh_src_dir}/package_compiler/bin/package_compiler compile ${bosh_release_dir}/release.yml ${bosh_release_dir}/release.tgz ${blobstore_path} ${agent_uri}
