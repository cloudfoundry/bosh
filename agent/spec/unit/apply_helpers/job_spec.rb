...
describe Bosh::Agent::ApplyHelpers::Job do
  ...
  def make_job(*args)
    Bosh::Agent::ApplyHelpers::Job.new(*args)
  end
  ...
  describe "installation" do
    ...
    describe "installation errors" do
      ...
      it "fails if configuration binding is not provided" do
        ...
        }.to raise_error(Bosh::Agent::ApplyHelpers::Job::InstallationError,
  ...
  describe "configuration" do
    ...
    describe "configuration errors" do
      ...
      it "fails if cannot bind monit file to configuration" do
        ...
        expect {
          job.configure
        }.to raise_error(Bosh::Agent::ApplyHelpers::Job::ConfigurationError,
