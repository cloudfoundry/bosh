...
describe Bosh::Agent::Message::Apply do
  ...
  it 'should install two jobs with two .monit files' do
    ...
    monitrc1 = File.join(Bosh::Agent::Config.base_dir, 'data', 'jobs', 'hubba', '77', '00_hubba.hubba_hubba.monitrc')
    File.exist?(monitrc1).should == true

    monitrc2 = File.join(Bosh::Agent::Config.base_dir, 'data', 'jobs', 'hubba2', '77', '01_hubba.hubba2_hubba.monitrc')
