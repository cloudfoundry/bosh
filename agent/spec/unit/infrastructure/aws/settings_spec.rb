...
describe Bosh::Agent::Infrastructure::Aws::Settings do
  ...
  it 'should get network settings' do
    ...
    network_settings.should have_key("apps")
    network_settings["apps"].should have_key("ip")
    network_settings["apps"].should have_key("netmask")
    network_settings["apps"].should have_key("dns")
    network_settings["apps"].should have_key("gateway")
    network_settings["apps"].should have_key("cloud_properties")
  end
