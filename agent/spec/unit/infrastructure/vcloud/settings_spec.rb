...
Bosh::Agent::Infrastructure.new("vcloud").infrastructure

describe Bosh::Agent::Infrastructure::Vcloud::Settings do

  before(:each) do
    Bosh::Agent::Config.settings_file = File.join(base_dir, 'bosh', 'settings.json')
    @settings = Bosh::Agent::Infrastructure::Vcloud::Settings.new
