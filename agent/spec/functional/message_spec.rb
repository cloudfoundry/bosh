...
describe "messages" do
  ...
  before(:all) do
    ...
    # @base_dir = "../tmp"
    # FileUtils.mkdir_p("#{@base_dir}/bosh/log")
    # add -b base_dir to agent
    ...
    puts "starting agent"
    command = "../bin/agent -n #{@nats_uri} -a #{@agent_id}"
  ...
  after(:all) do
    # agent shouldn't need to be stopped,
    # as the "stop" message should have taken care of it
    puts "stopping agent"
