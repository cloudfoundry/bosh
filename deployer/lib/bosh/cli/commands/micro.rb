  ...
  class Micro < Base
    ...
    def perform(*options)
      ...
      if update
        ...
        confirm_deployment("Updating micro BOSH instance #{desc}")
        ...
        confirm_deployment("Deploying new micro BOSH instance #{desc}")
    ...
    def find_deployment(name)
      check_if_deployments_dir
      File.expand_path(File.join(work_dir, "#{name}", "#{name}.yml"))
    end
