...
if [ "${stemcell_operating_system}" == "ubuntu" -o "${stemcell_operating_system_version}" == "7" ]; then
...
if [ "${stemcell_operating_system_version}" == "trusty" -o "${stemcell_operating_system_version}" == "7" ]; then
