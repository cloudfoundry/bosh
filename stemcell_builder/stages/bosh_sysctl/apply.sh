...
if [ "${stemcell_operating_system}" == "ubuntu" -o "${stemcell_operating_system_version}" == "7" -o "${stemcell_operating_system}" == "photonos" ]; then
...
if [ "${stemcell_operating_system_version}" == "trusty" -o "${stemcell_operating_system_version}" == "7" -o "${stemcell_operating_system}" == "photonos" ]; then
