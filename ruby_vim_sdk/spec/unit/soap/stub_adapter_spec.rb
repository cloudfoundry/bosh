...
describe VimSdk::Soap::StubAdapter do
  ...
  it "should send a method invocation" do
    ...
    expect{@stub.invoke_method(managed_object, method_info, arguments, nil)}.to raise_error("Can't assign requested address - connect(2) (://:0)")
  end
  ...
  it "should send a property invocation" do
    ...
    expect{@stub.invoke_property(managed_object, property_info)}.to raise_error("Can't assign requested address - connect(2) (://:0)")
  end
