   ...
   - Multiple instance groups provide links of type 'db'. Cannot decide which one to use for instance group 'optional_db'.
    ...
    context 'when exporting a release with templates that have links' do
      ...
      it 'should successfully compile a release without complaining about missing links' do
        ...
        expect(out).to include('Started copying jobs > api_server/5c28eb1095b96d138ab3c6f2e969db35773edc8d. Done')
        ...
        expect(out).to include('Started copying jobs > backup_database/d945c83d14a30a06b0b8a52833911c68d392b287. Done')
        expect(out).to include('Started copying jobs > database/578534accedf3d4abb69eef81480af9279d13660. Done')
        expect(out).to include('Started copying jobs > mongo_db/32309b46027aebb4573e09ab2f948ad1877a3e0e. Done')
