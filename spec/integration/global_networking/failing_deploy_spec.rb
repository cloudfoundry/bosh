...
describe 'failing deploy', type: :integration do
  ...
  it 'keeps static IP address when vm creation fails' do
    ...
    expect(second_deploy_output).to include("Failed to reserve IP '192.168.1.10' for instance 'foobar/0': already reserved by instance 'foobar/0' from deployment 'first'")
