...
describe 'resurrector', type: :integration, hm: true do
  ...
  it 'resurrects vms based on resurrection config' do
    resurrection_config_enabled = yaml_file('config.yml', Bosh::Spec::DeploymentManifestHelper.resurrection_config_enabled)
    resurrection_config_disabled = yaml_file('config.yml', Bosh::Spec::DeploymentManifestHelper.resurrection_config_disabled)
    ...
    deployment_hash_disabled['instance_groups'][1] = Bosh::Spec::DeploymentManifestHelper.simple_instance_group(job_opts)
  ...
  it "respects 'serial' property" do
    ...
    deployment_hash['instance_groups'][1] = Bosh::Spec::DeploymentManifestHelper.simple_instance_group(ig2)
