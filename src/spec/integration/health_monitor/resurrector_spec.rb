...
describe 'resurrector', type: :integration, hm: true do
  ...
  it 'resurrects vms based on resurrection config' do
    resurrection_config_enabled = yaml_file('config.yml', Bosh::Spec::Deployments.resurrection_config_enabled)
    resurrection_config_disabled = yaml_file('config.yml', Bosh::Spec::Deployments.resurrection_config_disabled)
  ...
  it "respects 'serial' property" do
    ...
    deployment_hash['instance_groups'][1] = Bosh::Spec::Deployments.simple_instance_group(ig2)
