...
describe 'User authorization with UAA', type: :integration do
  ...
  it 'should return tasks that user is permitted to view' do
    ...
    expect(output).to contain_exactly(
      {'id'=> '4',   'state'=> 'done',  'started_at'=>/.*/,   'finished_at'=>/.*/,  'user'=> 'production_team',  'deployment'=> 'simple',  'description'=> 'delete deployment simple',  'result'=> '/deployments/simple'},
      {'id'=> '3',  'state'=> 'done',  'started_at'=>/.*/,  'finished_at'=>/.*/,  'user'=> 'production_team',  'deployment'=> 'simple',  'description'=> 'create deployment',  'result'=> '/deployments/simple'}
    )
  end
end
