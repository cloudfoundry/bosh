...
describe 'cli: property management', type: :integration do
  ...
  it 'can get/set/unset deployment properties' do
    pending('cli2: #130551207: backport set-property command')
    pending('cli2: #130551225: backport get-property command')
    pending('cli2: #130551227: backport unset-property command')
    pending('cli2: #130551555: backport properties command')
