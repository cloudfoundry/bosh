  ...
  describe PermissionAuthorizer do
    ...
    describe '#is_granted?' do
      describe 'director subject' do
        ...
        describe 'checking for create_link rights' do
          let(:acl_right) { :create_link }
        ...
        describe 'checking for delete_link rights' do
          let(:acl_right) { :delete_link }
        ...
        describe 'checking for invalid rights' do
          ...
          it 'raises an exception' do
            ...
            end.to raise_error ArgumentError, "Unexpected permission for director: #{acl_right}"
          end
        end
      end
      ...
      describe 'deployment' do
        ...
        describe 'checking for invalid rights' do
          ...
          it 'raises an exception' do
            expect do
              subject.is_granted?(acl_subject, acl_right, ['bosh.admin'])
            end.to raise_error ArgumentError, "Unexpected permission for deployment: #{acl_right}"
          end
        end
      end
      ...
      describe 'unexpected subject' do
        ...
        it 'raises an exception' do
          expect do
            subject.is_granted?(acl_subject, acl_right, ['bosh.admin'])
          end.to raise_error ArgumentError, "Unexpected subject: #{acl_subject}"
        end
      end
    end
  end
