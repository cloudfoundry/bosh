...
module Bosh::Director
  describe 'associate_vm_info_with_vms_table' do
    ...
    it 'adds foreign key constraint on active_vm_id to instances' do
      ...
      DBSpecHelper.migrate(migration_file)
      expect{ db[:instances].where(id: 0).update(active_vm_id: 666) }.to raise_error Sequel::ForeignKeyConstraintViolation
    end
    ...
    describe 'backing up important columns' do
      ...
      it 'renames columns transferred to vms table (vm_cid, credentials_json, agent_id, trusted_certs_sha1)' do
        ...
        expect(db[:instances].all).to contain_exactly(
          {id: 0, active_vm_id: 1, job: 'blah', index: 0, deployment_id: db[:deployments].first[:id], variable_set_id: db[:variable_sets].first[:id], state: 'running', agent_id_bak: '99', vm_cid_bak: '100', credentials_json_bak: '{"foo":"bar"}', trusted_certs_sha1_bak: "some-trusted-cert-sha1", resurrection_paused: false, uuid: nil, availability_zone: nil, cloud_properties: nil, compilation: false, bootstrap: false, dns_records: nil, spec_json: nil, update_completed: false, ignore: false },
          {id: 1, active_vm_id: 2, job: 'blah', index: 1, deployment_id: db[:deployments].first[:id], variable_set_id: db[:variable_sets].first[:id], state: 'running', agent_id_bak: '100', vm_cid_bak: '101', credentials_json_bak: '{"foo":"bar"}', trusted_certs_sha1_bak: "some-trusted-cert-sha1", resurrection_paused: false, uuid: nil, availability_zone: nil, cloud_properties: nil, compilation: false, bootstrap: false, dns_records: nil, spec_json: nil, update_completed: false, ignore: false },
          {id: 2, active_vm_id: 3, job: 'blah', index: 2, deployment_id: db[:deployments].first[:id], variable_set_id: db[:variable_sets].first[:id], state: 'running', agent_id_bak: '101', vm_cid_bak: '102', credentials_json_bak: '{"foo":"bar"}', trusted_certs_sha1_bak: "some-trusted-cert-sha1", resurrection_paused: false, uuid: nil, availability_zone: nil, cloud_properties: nil, compilation: false, bootstrap: false, dns_records: nil, spec_json: nil, update_completed: false, ignore: false },
          {id: 3, active_vm_id: 4, job: 'blah', index: 3, deployment_id: db[:deployments].first[:id], variable_set_id: db[:variable_sets].first[:id], state: 'running', agent_id_bak: '102', vm_cid_bak: '103', credentials_json_bak: '{"foo":"bar"}', trusted_certs_sha1_bak: "some-trusted-cert-sha1", resurrection_paused: false, uuid: nil, availability_zone: nil, cloud_properties: nil, compilation: false, bootstrap: false, dns_records: nil, spec_json: nil, update_completed: false, ignore: false },
          {id: 4, active_vm_id: nil, job: 'blah', index: 3, deployment_id: db[:deployments].first[:id], variable_set_id: db[:variable_sets].first[:id], state: 'running', agent_id_bak: '103', vm_cid_bak: nil, credentials_json_bak: '{"foo":"bar"}', trusted_certs_sha1_bak: "some-trusted-cert-sha1", resurrection_paused: false, uuid: nil, availability_zone: nil, cloud_properties: nil, compilation: false, bootstrap: false, dns_records: nil, spec_json: nil, update_completed: false, ignore: false },
        )
