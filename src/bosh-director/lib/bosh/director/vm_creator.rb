...
module Bosh::Director
  ...
  class VmCreator
    ...
    def create(instance, stemcell_cid, cloud_properties, network_settings, disks, env, factory)
      ...
      env = config_server_client.interpolate_with_versioning(Bosh::Common::DeepCopy.copy(env), instance.desired_variable_set)
      cloud_properties = config_server_client.interpolate_with_versioning(Bosh::Common::DeepCopy.copy(cloud_properties), instance.desired_variable_set)
