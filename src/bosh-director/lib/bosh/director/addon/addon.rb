  ...
  module Addon
    ...
    class Addon
      ...
      def applies?(deployment, deployment_instance_group)
        @addon_include.applies?(deployment, deployment_instance_group) && !@addon_exclude.applies?(deployment, deployment_instance_group)
      end
      ...
      def add_to_deployment(deployment)
        ...
        deployment.instance_groups.each do |instance_group|
          if applies?(deployment, instance_group)
