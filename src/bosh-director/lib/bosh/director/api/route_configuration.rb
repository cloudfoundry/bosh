    ...
    module Api
      class RouteConfiguration
        ...
        def controllers
          ...
          controllers['/director'] = Bosh::Director::Api::Controllers::DirectorController.new(@config)
          controllers['/dynamic_disks'] = Bosh::Director::Api::Controllers::DynamicDisksController.new(@config)
          ...
          controllers['/deployed_variables'] = Bosh::Director::Api::Controllers::DeployedVariablesController.new(@config)
          controllers
        end
      end
    end
