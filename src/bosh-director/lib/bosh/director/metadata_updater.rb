module Bosh::Director
  class MetadataUpdater
    ...
    def generate_vm_metadata(instance, base_metadata = {})
      metadata = base_metadata.clone.merge(@director_metadata)
    ...
    def update_vm_metadata(vm, metadata, factory = CloudFactory.create)
