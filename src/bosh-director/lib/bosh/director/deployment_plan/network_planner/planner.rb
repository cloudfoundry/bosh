  ...
  module NetworkPlanner
    class Planner
      ...
      def network_plan_with_dynamic_reservation(instance_plan, job_network)
        reservation = Bosh::Director::DesiredNetworkReservation.new_dynamic(instance_plan.instance.model, job_network)
      ...
      def network_plan_with_static_reservation(instance_plan, job_network, static_ip)
        reservation = Bosh::Director::DesiredNetworkReservation.new_static(instance_plan.instance.model, job_network, static_ip)
