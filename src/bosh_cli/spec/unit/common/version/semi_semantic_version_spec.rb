require 'cli/common/version/semi_semantic_version'

module Bosh::Cli::Common::Version
  describe SemiSemanticVersion do
    ...
    describe '#increment_post_release' do
      ...
      it 'fails when post-release is nil' do
        expect{a.increment_post_release}.to raise_error(Bosh::Cli::Common::Version::UnavailableMethodError)
      end
