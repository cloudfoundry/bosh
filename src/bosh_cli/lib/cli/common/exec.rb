...
require 'cli/common/exec/result'
require 'cli/common/exec/error'
...
module Bosh
  module Cli
    ...
    module Exec
      ...
      #     cmd = "ls /"
      #     result = Bosh::Cli::Exec::Result.new(cmd, "bin etc var", "", 0)
      #     Bosh::Cli::Exec.should_receive(:sh).with(cmd).and_return(result)
      ...
      #   return [Bosh::Cli::Exec::Result] instead of raising [Bosh::Cli::Exec::Error]
      ...
      # @yield [Bosh::Cli::Exec::Result] command result
      # @return [Bosh::Cli::Exec::Result] command result
      # @raise [Bosh::Cli::Exec::Error] raised when the command isn't found or
