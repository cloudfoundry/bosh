require 'ostruct'
require 'cli/bosh/template/evaluation_failed'
require 'cli/bosh/template/unknown_property'
require 'cli/bosh/template/unknown_link'
require 'cli/bosh/template/property_helper'
require 'cli/bosh/template/evaluation_link_instance'
require 'cli/bosh/template/evaluation_link'
  ...
  module Cli
    module Template
      ...
      class EvaluationContext
        ...
        #   @param [Array<String>] names Property names
        #   @return [Object] Property value
        #   @raise [Bosh::Cli::Common::UnknownProperty]
        #
        # @overload p(name)
