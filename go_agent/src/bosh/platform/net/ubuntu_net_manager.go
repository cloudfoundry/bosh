...
func (net ubuntu) SetupDhcp(networks boshsettings.Networks) (err error) {
	...
	written, err := net.fs.WriteToFile("/etc/dhcp3/dhclient.conf", buffer.String())
	if err != nil {
...
func (net ubuntu) writeNetworkInterfaces(networks boshsettings.Networks) (modifiedNetworks []CustomNetwork, err error) {
	...
	_, err = net.fs.WriteToFile("/etc/network/interfaces", buffer.String())
	if err != nil {
...
func (net ubuntu) writeResolvConf(networks boshsettings.Networks) (err error) {
	buffer := bytes.NewBuffer([]byte{})
	...
	_, err = net.fs.WriteToFile("/etc/resolv.conf", buffer.String())
	if err != nil {
