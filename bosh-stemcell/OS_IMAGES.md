...
* `vGp8loonc7U8DMCFrkKHPHHU.2pjCciU`
  - USN-3334-1: Linux kernel (Xenial HWE) vulnerabilities
  - built from 257.x-3263.x (f77b44cec8ed7d23a1d9360ae9ff26243668db6d)

* `KtFSLY7U3zNQf1XrDts0Pl6tG96odMu9`
  - periodic bump
  - built from 257.x-3263.x (6b8588cbd40a5177ffd63b504431b6485e3ccf3e)

* `lp8Pv8NUigo_nJxZYNMJtsBPf3GNTcJK`
  - periodic bump
  - built from 257.x-3263.x (80868eb6214f5465e4e60950ebe035488b541035)

* `yb4EV1rfPEhOn6TANYiZSVkhsR3YgdDG`
  - periodic bump
  - built from 257.x-3263.x (1d1feae0c4953d3ad0e8058b582393147121335a)

* `NNzRJATXJ6ZZwVNefp5XxOqEPP2pg3Tc`
  - USN-3265-2: Linux kernel vulnerability
  - built from 257.x-3263.x (6cd2c306b476eabc73c557057a4240c847603e09)

* `qjzA0Ktd1s3RZ6kGSCI2znD4kbmHbDn9`
  - USN-3249-2: Linux kernel (Xenial HWE) vulnerability
  - built from 257.x-3263.x (287bca3281fcfd6db9de71136e0d8cdc1664dafe)

* `df4GMKHhVHPcsh3HlaXinDEshMao4vVS`
  - USN-3220-2: Linux kernel (Xenial HWE) vulnerability
  - built from 257.x-3263.x (17027d22336b91ecdcd80e42cb01b943b94504ba)

* `p..OgjjkEo9SMs6cRv8BK1.F_YbEJS2p`
  - USN-3209-1: SCSI operation restriction
  - built from 257.x-3263.x (2adb28970d7c399104a7f8c4d195f9b9dbdedf40)
...
* `x48PlmakbUwR41AFDf7IG.WaJ1.w82NG`
  - Periodic bump
  - built from 257.x-3263.x (9b1d0d05009d36b28e1d1a4e1e038f15d5be1278)

* `2OHnsylZqk22MKk565AAj6A_cnMgsYXN`
  - Periodic bump
  - built from 257.x-3263.x (dc10510a48ea2e77f107644858a4875118ed88b5)

* `fnsqKZYfgbfM1Fn4fQ739bDde6c9uPsl`
  - Pin rsyslog to version 8.22
  - built from 257.x-3263.x (4e33d8ce9e58684edf738103a35f643823f189f3)

* `pXrNoL544aDEFwaznc1r0CNTFeXq3.UE`
  - USN-3156-1: APT vulnerability
  - built from 257.x-3263.x (41edff6464246431d6440b2446bb9cc5f872167f)

* `VzS6WMWhukwdablTBJZzeeN35cA6GZk6`
  - USN-3151-2: Linux kernel (Xenial HWE) vulnerability
  - built from 257.x-3263.x (35fde2e9c51435e7ebe93c25c619874a0d919269)
...
* `Ike6Vyqu3kuHWWihXoLa3jbxIqNXNTV5`
  - USN-3151-2: Linux kernel (Xenial HWE) vulnerability
  - built from 257.x-3263.x (35fde2e9c51435e7ebe93c25c619874a0d919269)
