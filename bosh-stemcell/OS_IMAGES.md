...
* `cl0zExzyMKzKDkiCiWj2rFUT9nnTSNbh`
  - USN-3540-2: Linux kernel (Xenial HWE) vulnerabilities
  - built from 3312.x (71f4431787ae7ada688f60ba34a6524e4946aa11)

* `iJKht.Pzr2Ih47uImo9Xz6yQasNl189D`
  - USN-3522-4: Linux kernel (Xenial HWE) vulnerabilities
  - built from 3312.x (36bd24bf0f4ef876baeae7500b018484b3eb8978)

* `SPKqnaM2N0vU4Dh7AqXHi6dz_RTZwPAw`
  - USN-3522-2: Linux kernel (Xenial HWE) vulnerabilities
  - built from 3312.x (cfb5db790f51614437dc9fcd011ecacc9f4d1960)

* `MsIZgcGB4FUhZvygBFT0SSyNYa8xY9TJ`
  - USN-3509-2: Linux kernel (Xenial HWE) vulnerabilities
  - built from 3312.x (1b705cef5efa4a3fc05186efd0466effe092005b)
...
* `JaLIWoQ0quIQ3sWGhe.hJ.vdbSg4o_JN`
  - Periodic bump
  - built from 3312.x (3eb391e813351f87f23f89909a900e8c68a0e69b)
...
* `ZOxzxVcDgdoaNHfY_QgWEeovmL7Jqoik`
  - USN-3392-2: Linux kernel (Xenial HWE) regression
  - built from 3312.x (226d59573c2e2832c67831a67e18689b177bb292)

* `V9nBnQ62YlvgwSBzDerRIOn18yDlv.vE`
  - USN-3385-2: Linux kernel (Xenial HWE) vulnerabilities
  - built from 3312.x (e3d57430f5709001e7cc78087a0f9698666fa721)

* `gQ_ApIAKXY2otGN30o97J1wTHpjFQ2xz`
  - USN-3378-2: Linux kernel (Xenial HWE) vulnerabilities
  - built from 3312.x (92bfa5b1526d3b31b4bc5d5450df6bb185ac27fb)

* `SVJ_rbqgnWxNT6IBG5owOb5wAKv20Q9.`
  - Periodic bump
  - built from 3312.x (47ea012da9d844f767fdfe71a064ba94667afbfe)

* `n7ejFTHizZSixazjrcHJRCZtRSB_4b4u`
  - USN-3344-2: Linux kernel (Xenial HWE) vulnerabilities
  - built from 3312.x (fafdcd1aec3f56821cd7f354fbc4df107671351c)

* `j1gDmcfHB1_kQJHI66WkCKld2qygZhi5`
...
* `tTkI.zv1KBWhUkwOAbPbXpzO16YMWmnd`
  - periodic bump
  - built from 3312.x (3d58e4d1a49e163aaac0c28e45567160850e928c)

* `HdXY_vpLrUjDfblih3nIHL0Dj6yiqiUo`
  - periodic bump
  - built from 3312.x (26dab1c1f3a76baac062a38764caaea362a1a961)

* `Ow_k09FJScyUx1hcxv22gxUuS5GEHPcF`
  - USN-3265-2: Linux kernel vulnerability
  - built from 3312.x (96fe9f96c19f2c333a827d61562f4cfe292ec68f)

* `2vQGJsJ.qsYIgP6oqC5eVlRueJKuCcms`
  - USN-3256-1: Linux kernel vulnerability
  - built from 3312.x (af0f89f69aea40b78b84ef829beca177f9f6fefc)

* `dGAlmZwag6wiZt2athoaJDQAvE4YexJW`
  - USN-3249-2: Linux kernel (Xenial HWE) vulnerability
  - built from 3312.x (816b264eba871b07b4abc5e9a3bb253773e870f5)

* `jSnlZlkOm2ZvlfK4EDfTBsE6MkbcmC5r`
  - USN-3220-2: Linux kernel (Xenial HWE) vulnerability
  - built from 3312.x (d723f8694b587336ee74f93b1bc7eed4d4ecc3ed)
...
* `mnC1ygIEAgs2eKFdc_LPrQtDkxHPSP6e`
  - Backport DSA Host keys
  - built from 3312.x (2971f6103020f82ba84b92c9f55386c157b69273)

* `JmSCN_vGBO2kHrlfdZzqBkxG0qLQmAri`
  - Periodic bump
  - built from 3312.x (b53b621d1356ce59bab0dd8525d88ff5e0f31339)

* `G0cEsczqZZB_worHS3HrUGMBwxY8Aznr`
  - Periodic bump
  - built from 3312.x (e89a0167052d959e626834bd11dcbb8896717048)

* `9yBQtZBq0pgAmVMAo4s_I8he1dcASnik`
  - Periodic bump
...
* `5bAY7EvrOh.u1QKmL4I2SAcZJX0ou1ff`
  - bumped for https://www.ubuntu.com/usn/usn-3156-1/
  - built from 3312.x (05d58803d75b844288196c8d7126f9e09f9a6a69)

* `s52rq4q3NTsr3EJivPoKCebDIXbD.Kx0`
  - bumped for https://www.ubuntu.com/usn/usn-3151-2/
  - built from 3312.x (3611a3d29adbca5c45b5834b490519e114d7c0f7)
...
* `3sburm4cQ_HIlAoZ9EsIgpeW0JSPxoUs`
  - bumped for https://www.ubuntu.com/usn/usn-3151-2/
  - built from 3312.x (3611a3d29adbca5c45b5834b490519e114d7c0f7)

* `9gVqn2z5vRs5W0s5dZVRoGBP4BGlKCce`
  - periodic bump
  - built from 3312.x (7bf28beb5b7f85ba4d2af67ac08d5b2df5b6fbaa)
