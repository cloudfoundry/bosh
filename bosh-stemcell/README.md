...
1. Start up or re-provision the stemcell building machine (run `vagrant up` or `vagrant provision` from this directory)
2. Download the [Photon Latest ISO](https://vmware.bintray.com/photon/iso/) image and use `scp` to copy it to the stemcell building machine. Please download Photon ISO from TP2-working or TP2. Note: Photon TP2 is not yet released. It will be available in above link after it is released. Please use TP2-working ISO to build stemcell.
