...
module Bosh::Director
  ...
  JobSpecMissingRelease = err(140001)
  JobSpecUnknownRelease = err(140002)
  JobSpecUnknownResourcePool = err(140003)
  JobSpecInvalidInstanceIndex = err(140004)
  JobSpecInvalidInstanceState = err(140005)
  JobSpecInvalidJobState = err(140006)
  JobSpecMissingNetwork = err(140007)

  JobNetworkSpecUnknownNetwork = err(150001)
  JobNetworkSpecInstanceIpMismatch = err(150002)
  JobNetworkSpecInvalidDefault = err(150003)
  JobNetworkSpecMultipleDefaults = err(150004)
  JobNetworkSpecMissingDefault = err(150005)
