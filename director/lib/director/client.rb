...
module Bosh::Director
  class Client
    ...
    def download_and_delete_blob(blob_id)
      ...
      @logger.debug("Downloading #{blob_id} from blobstore...")
      blob = @resource_manager.get_resource(blob_id)
      @logger.debug("Downloaded #{blob_id} from blobstore")
      blob
    ensure
      @logger.debug("Deleting #{blob_id} from blobstore...")
      @resource_manager.delete_resource(blob_id)
      @logger.debug("Deleted #{blob_id} from blobstore")
    end
