module Bosh::Director
  class InstanceUpdater
    ...
    def update(options = {})
      ...
      step do
        watch_schedule(min_watch_time, max_watch_time).each do |watch_time|
          ...
          break if @target_state == "started" && current_state["job_state"] == "running"
          break if @target_state == "stopped" && current_state["job_state"] != "running"
        end
      end
    ...
    def sleep(time) # extracted for testing
      Kernel.sleep(time)
    end
