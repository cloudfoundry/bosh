module Bosh::Director
  ...
  class VmCreator
    ...
    def self.create(deployment, stemcell, cloud_properties, network_settings, disks=nil, env={})
      new.create(deployment, stemcell, cloud_properties, network_settings, disks, env)
    end
