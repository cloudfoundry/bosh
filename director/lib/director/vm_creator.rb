module Bosh::Director
  ...
  class VmCreator
    ...
    def self.create(deployment, stemcell, cloud_properties, network_settings,
                    disks=nil, env={})
      new.create(deployment, stemcell, cloud_properties, network_settings,
                 disks, env)
    end
    ...
    def create(deployment, stemcell, cloud_properties, network_settings,
      ...
      vm_cid = @cloud.create_vm(agent_id, stemcell.cid, cloud_properties, network_settings,
                                disks, env)
      vm.cid = vm_cid
      vm.save
      vm
