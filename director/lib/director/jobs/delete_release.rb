  ...
  module Jobs
    class DeleteRelease < BaseJob
      ...
      def delete_release_version(release_version)
        @event_log.begin_stage("Deleting release version", 1, [ @name, @version ].compact)
      ...
      def delete_release(release)
        ...
        @event_log.begin_stage("Deleting package", release.packages.count)
        ...
        @event_log.begin_stage("Deleting template", release.templates.count)
