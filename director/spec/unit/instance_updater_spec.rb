...
describe Bosh::Director::InstanceUpdater do
  ...
  it "should update the dns when needed" do
    ...
    dns_records["4.3.2.1.in-addr.arpa"] = "0.some.record"
    dns_records["3.2.1.in-addr.arpa"] = "ns.bosh"
    dns_records["8.7.6.5.in-addr.arpa"] = "0.some.other.record"
    dns_records["7.6.5.in-addr.arpa"] = "ns.bosh"
