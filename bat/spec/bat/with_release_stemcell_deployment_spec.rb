...
describe 'with release, stemcell and deployment' do
  ...
  describe 'managed properties' do
    context 'with no property' do
      it 'should not return a value' do
          ...
          }.to raise_error(Bosh::Exec::Error, /Error 110003/)
      end
  ...
  context 'release' do
    describe 'upload' do
      ...
      it 'should fail when the release already is uploaded' do
        ...
        }.to raise_error(Bosh::Exec::Error, /This release version has already been uploaded/)
      end
    end
    ...
    describe 'delete' do
      ...
      context 'in use' do
        it 'should not be possible to delete' do
          ...
          }.to raise_error(Bosh::Exec::Error, /Error 30007/)
  ...
  context 'stemcell' do
    it 'should not delete a stemcell in use' do
      ...
      }.to raise_error(Bosh::Exec::Error, /Error 50004/)
    end
  end
end
