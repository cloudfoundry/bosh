  ...
  describe 'aws bootstrap bosh' do
    ...
    context 'when the prerequisites are all met' do
      ...
      before do
        ...
        mock_s3.should_receive(:copy_remote_file).with('bosh-jenkins-artifacts','bosh-stemcell/aws/light-bosh-stemcell-latest-aws-xen-ubuntu-lucid.tgz','bosh_stemcell.tgz').and_return(stemcell_stub)
