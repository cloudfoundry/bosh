  ...
  class Cloud < Bosh::Cloud
    ...
    def create_vm(agent_id, stemcell_id, resource_pool,
      ...
      with_thread_name("create_vm(#{agent_id}, ...)") do
        ...
        settings = initial_agent_settings(agent_id, network_spec,
                                          resource_pool, environment)
    ...
    # @return [Hash]
    def initial_agent_settings(agent_id, network_spec, resource_pool,
                               environment)
      if resource_pool && resource_pool["root_device_name"]
        root_device_name = resource_pool["root_device_name"]
      else
