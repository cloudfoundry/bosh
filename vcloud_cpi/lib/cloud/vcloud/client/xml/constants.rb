module VCloudCloud
  module Client
    module Xml
      ...
      # See http://blogs.vmware.com/vapp/2009/11/virtual-hardware-in-ovf-part-1.html
      HARDWARE_TYPE = {
          :CPU => '3',
          :MEMORY => '4',
          :SCSI_CONTROLLER => '6',
      ...
      MEDIA_TYPE = {
          ...
          :UPLOAD_VAPP_TEMPLATE_PARAMS => 'application/vnd.vmware.vcloud.uploadVAppTemplateParams+xml',
          :INSTANTIATE_OVF_PARAMS => 'application/vnd.vmware.vcloud.instantiateOvfParams+xml',
          ...
          :CLONE_VAPP_TEMPLATE_PARAMS => 'application/vnd.vmware.vcloud.cloneVAppTemplateParams+xml',
          :CLONE_MEDIA_PARAMS => 'application/vnd.vmware.vcloud.cloneMediaParams+xml',
          :DEPLOY_VAPP_PARAMS => 'application/vnd.vmware.vcloud.deployVAppParams+xml',
          :UNDEPLOY_VAPP_PARAMS => 'application/vnd.vmware.vcloud.undeployVAppParams+xml',
          :UNDEPLOY_VAPP_PARAMS_EXTENDED => 'application/vnd.vmware.vcloud.undeployVAppParamsExtended+xml',
          :CAPTURE_VAPP_PARAMS => 'application/vnd.vmware.vcloud.captureVAppParams+xml',
          :COMPOSE_VAPP_PARAMS => 'application/vnd.vmware.vcloud.composeVAppParams+xml',
          ...
          :MEDIA_INSERT_EJECT_PARAMS => 'application/vnd.vmware.vcloud.mediaInsertOrEjectParams+xml',
          :QUESTION => 'application/vnd.vmware.vcloud.vmPendingQuestion+xml',
          :ANSWER => 'application/vnd.vmware.vcloud.vmPendingAnswer+xml',
          :RECOMPOSE_VAPP_PARAMS => 'application/vnd.vmware.vcloud.recomposeVAppParams+xml',
          :RELOCATE_VM_PARAMS => 'application/vnd.vmware.vcloud.relocateVmParams+xml',
          ...
          :METADATA_ITEM_VALUE => 'application/vnd.vmware.vcloud.metadata.value+xml',
          :ENTITY_REFERENCE => 'application/vnd.vmware.vcloud.entity.reference+xml',
          :DISK => 'application/vnd.vmware.vcloud.disk+xml',
          :DISK_CREATE_PARAMS => 'application/vnd.vmware.vcloud.diskCreateParams+xml',
          :DISK_ATTACH_DETACH_PARAMS => 'application/vnd.vmware.vcloud.diskAttachOrDetachParams+xml',
          :VDC_STORAGE_CLASS => 'application/vnd.vmware.vcloud.vdcStorageClass+xml',
          :VDC_STORAGE_PROFILE => 'application/vnd.vmware.vcloud.vdcStorageProfile+xml',
          :ALLOCATED_NETWORK_IPS => 'application/vnd.vmware.vcloud.allocatedNetworkAddress+xml',
          :LEASE_SETTINGS_SECTION => 'application/vnd.vmware.vcloud.leaseSettingsSection+xml',
          :STARTUP_SECTION => 'application/vnd.vmware.vcloud.startupSection+xml',
          :NETWORK_SECTION => 'application/vnd.vmware.vcloud.networkSection+xml',
          ...
          :NETWORK_CONNECTION_SECTION => 'application/vnd.vmware.vcloud.networkConnectionSection+xml',
          :OPERATING_SYSTEM_SECTION => 'application/vnd.vmware.vcloud.operatingSystemSection+xml',
          :VIRTUAL_HARDWARE_SECTION => 'application/vnd.vmware.vcloud.virtualHardwareSection+xml',
          :RUNTIME_INFO_SECTION => 'application/vnd.vmware.vcloud.runtimeInfoSection+xml',
          :GUEST_CUSTOMIZATION_SECTION => 'application/vnd.vmware.vcloud.guestCustomizationSection+xml',
          :CUSTOMIZATION_SECTION => 'application/vnd.vmware.vcloud.customizationSection+xml',
      ...
      ADMIN_MEDIA_TYPE = {
        ...
        :VM => "application/vnd.vmware.vcloud.vm+xml",
        :MEDIA => "application/vnd.vmware.vcloud.media+xml",
        :SYSTEM_ADMIN_ORGANIZATION => "application/vnd.vmware.admin.systemOrganization+xml",
        ...
        :CATALOG_PUBLISH => "application/vnd.vmware.admin.publishCatalogParams+xml",
        :OWNER => "application/vnd.vmware.vcloud.owner+xml",
        :ORG_SETTINGS => "application/vnd.vmware.admin.orgSettings+xml",
        :VAPP_TEMPLATE_LEASE_SETTINGS => "application/vnd.vmware.admin.vAppTemplateLeaseSettings+xml",
        :VAPP_LEASE_SETTINGS => "application/vnd.vmware.admin.vAppLeaseSettings+xml",
        :EMAIL_SETTINGS => "application/vnd.vmware.admin.organizationEmailSettings+xml",
        :GENERAL_SETTINGS => "application/vnd.vmware.admin.organizationGeneralSettings+xml",
        :ORGANIZATION_PASSWORD_POLICY_SETTINGS => "application/vnd.vmware.admin.organizationPasswordPolicySettings+xml",
      }
      ...
      XML_TYPE = {
        ...
        :DATASTOREPROVIDERVDCRELATIONRECORD => "DatastoreProviderVdcRelationRecord",
        ...
        :PROVIDERVDCRESOURCEPOOLRELATIONRECORD => "ProviderVdcResourcePoolRelationRecord",
