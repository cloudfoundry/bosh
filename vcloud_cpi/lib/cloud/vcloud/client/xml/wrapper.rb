    ...
    module Xml
      ...
      class WrapperFactory
        ...
        class << self
          ...
          # TODO: We might run into a bug later if there's ever XML node types
          ...
          def create_instance(type_name, ns = nil, namespace_defintions = nil,
            ...
            if (xml)
              ...
              raise "XML type #{type_name} not found in xml_templates dir."
            end
          end
      ...
      class Wrapper
        # Because we're wrapping individual nodes in a wrapper and turning them
        ...
        def create_qualified_name(name, href)
          ...
          raise "Namespace #{href} not found." unless namespace_wanted
        ...
        # There seem to be a Nokogiri bug such that attributes' namespace
        ...
        def add_child(child, namespace_prefix = nil, namespace_href = nil,
          ...
          if child.is_a? Wrapper
            ...
            raise "Namespace prefix must both be nil or defined together." if
              (namespace_prefix.nil? ^ namespace_href.nil?)
        ...
        def add_namespaces
          ...
          # will remove the original namespace and assume you're setting a new
